...
void test_deinterleave() {
    ...
    dst.output_buffer().dim(0).set_stride(1).dim(2).set_extent(3);
    ...
    double t1 = benchmark([&]() { dst.realize(dst_image); });
    ...
    double t2 = benchmark([&]() { dst.realize(dst_image); });
...
void test_interleave(bool fast) {
    ...
    dst.output_buffer().dim(0).set_stride(3).dim(2).set_stride(1).set_bounds(0, 3);
    ...
    double t = benchmark([&]() { dst.realize(dst_image); });
